# ? **GitHub Copilot エージェントを使用した Next.js 旅行アプリケーション開発**

## ? **目的**

GitHub Copilot エージェントの AI アシスタント機能を活用して、Next.js 旅行アプリケーションに新機能を効率的に実装する方法を学習します。Issue の作成、Copilot エージェントへの割り当て、およびAI駆動開発のワークフローを実践的に体験します。
...
1-3. **Issue に Copilot エージェントを割り当て**  
...
2-2. **実装プロセスの開始**  
 ...
 - 必要なファイル構造を自動生成  
 - コンポーネントの実装を開始  
![alt text](image/doing-copilot.png)
...
3-3. **ローカル環境での動作確認**  
 ...
 - ※ハンズオンでは詳細手順は省略しますが、本格運用では必須のステップです  
